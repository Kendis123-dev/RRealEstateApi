...
{
    public class RealEstateDbContext : IdentityDbContext<ApplicationUser, IdentityRole, string>
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            // Cascade delete for Listing to Property
            ...
            // Agent relationship: If agent is deleted, AgentId in user is set to null
            modelBuilder.Entity<ApplicationUser>()
                .HasOne(u => u.Agent)
                .WithMany(a => a.Users)
                //.HasForeignKey(u => u.AgentId)
                .OnDelete(DeleteBehavior.Restrict); // Prevent deletion if Agent is still linked to a user
